...
* [ ] 반환된 유저 객체는 email을 포함한다
* [ ] 반환된 유저 객체는 username을 포함한다
* [ ] 반환된 유저 객체는 token을 포함한다
* [ ] 이미 존재하는 이메일이면 422를 반환한다
* [ ] 비밀번호가 없으면 422를 반환한다
* [ ] username이 비어 있으면 422를 반환한다
...
* [ ] 존재하는 username으로 프로필을 조회하면 profile 객체를 반환한다
* [ ] 로그인하지 않아도 프로필 조회가 가능하다
